...
X_true = np.genfromtxt("./SimulatedData/Cluster/x1.csv")
...
for sim in range(0,25):
    ...
    x = np.genfromtxt("./SimulatedData/Cluster/x" + str(1 + sim) + ".csv")
    m = np.genfromtxt("./SimulatedData/Cluster/m" + str(1 + sim) + ".csv")
    adj_true = np.genfromtxt("./SimulatedData/Cluster/adj" + str(1 + sim) + ".csv")
    B_true = np.genfromtxt("./SimulatedData/Cluster/B" + str(1 + sim) + ".csv")
    ...
    np.savetxt("./Results/NetworkResults_Cluster_update_tau.csv",results, delimiter=",")
    np.savetxt("./Results/CoefficientResults_Cluster_update_tau.csv",results_B, delimiter=",")
