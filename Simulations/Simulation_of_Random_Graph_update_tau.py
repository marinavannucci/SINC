...
B_true = np.genfromtxt("./SimulatedData/Random/B1.csv")
X_true = np.genfromtxt("./SimulatedData/Random/x1.csv")
...
for sim in range(0,25):
    ...
    x = np.genfromtxt("./SimulatedData/Random/x" + str(1 + sim) + ".csv")
    m = np.genfromtxt("./SimulatedData/Random/m" + str(1 + sim) + ".csv")
    adj_true = np.genfromtxt("./SimulatedData/Random/adj" + str(1 + sim) + ".csv")
    B_true = np.genfromtxt("./SimulatedData/Random/B" + str(1 + sim) + ".csv")
    ...
    np.savetxt("./Results/NetworkResults_Random_update_tau.csv",results, delimiter=",")
    np.savetxt("./Results/CoefficientResults_Random_update_tau.csv",results_B, delimiter=",")
