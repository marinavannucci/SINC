...
// [[Rcpp::export]]
List mLDM_NO(NumericMatrix X, NumericMatrix M, double Z_mean = 1.0, int max_iteration = 2001, double threshold = 1e-4, int approx_num_Z = 10,
          ...
          int max_iteration_B_coor = 20, double threshold_B_coor = 1e-6, double ratio1 = 0.01, double ratio2 = 0.99, bool verbose = false, double lam1 = .5, int lam2 = 5) {
  ...
  NumericVector lambda2_list = seq(lam1, lam1, Named("length", 1));
  NumericVector lambda1_list = seq(ratio1, ratio2, Named("length", lam2));
